...
% ======================
\section{Introdução}
Este documento ensina LaTeX usando boas práticas e exemplos reais.
Ideal para quem está começando e deseja manter os arquivos limpos e organizados.
...
Para colocar uma equação dentro de uma linha de texto, use cifrões simples \verb|$...$| ou o
comando \verb|\(...\)|.
...
% ======================
\section{Conclusão}
O \LaTeX\ é poderoso e ideal para textos técnicos e científicos.
Seguindo boas práticas, você terá documentos bem organizados, limpos e profissionais.
